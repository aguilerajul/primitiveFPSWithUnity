...
public class WeaponController : WeaponEntity
{
    void Awake()
    {
        ...
        this._dualPistol = GameObject.FindGameObjectWithTag("Pistol2");
    }
    ...
    private void SetDefaultWeapon()
    {
        ...
        if (this._dualPistol != null)
            this._dualPistol.SetActive(false);
    ...
    private void SetDualPistol()
    {
        ...
        {
            this._pistol.SetActive(true);
            this._dualPistol.SetActive(true);
    ...
    {
        if (weaponName == this._dualPistol.name)
        {
            _hasDualPistol = true;
